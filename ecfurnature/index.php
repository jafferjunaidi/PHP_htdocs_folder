                        ...
                        <?php
                            ...
                            foreach($select as $data)
                            {
                                ...
                                <div class='single_product_item'>
                                    <img src='admin/product_pictures/$data[Product_images]' alt=''>
                                    <div class='single_product_text'>
                                        <h4>$data[Product_name]</h4>
                                        <h3>Rs. $data[Product_price]</h3>
                                        <a href='#' class='add_cart'>+ add to cart<i class='ti-heart'></i></a>
                                        <a href='single_product.php?A=$data[Pid]' class='add_cart'>&nbsp&nbsp&nbsp view details</a>
                                    </div>
                                </div>
                            </div>
                                ";
